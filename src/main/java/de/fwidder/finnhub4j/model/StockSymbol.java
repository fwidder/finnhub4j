...
public class StockSymbol {
     ...
     * @return mic
     **/
    @ApiModelProperty(value = "Primary exchange's MIC.")
     ...
     * @return figi
     **/
    @ApiModelProperty(value = "FIGI identifier.")
     ...
     * @return currency
     **/
    @ApiModelProperty(value = "Price's currency. This might be different from the reporting currency of fundamental data.")
     ...
     * @return symbol2
     **/
    @ApiModelProperty(value = "Alternative ticker for exchanges with multiple tickers for 1 stock such as BSE.")
     ...
     * @return isin
     **/
    @ApiModelProperty(value = "ISIN. This field is only available for EU stocks and selected Asian markets. Entitlement from Finnhub is required to access this field.")
