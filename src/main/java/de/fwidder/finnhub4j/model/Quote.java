...
public class Quote {
     ...
     * @return o
     **/
    @ApiModelProperty(value = "Open price of the day")
    public Float getO() {
        return o;
    }
     ...
     * @return h
     **/
    @ApiModelProperty(value = "High price of the day")
    public Float getH() {
        return h;
    }
     ...
     * @return l
     **/
    @ApiModelProperty(value = "Low price of the day")
    public Float getL() {
        return l;
    }
     ...
     * @return dp
     **/
    @ApiModelProperty(value = "Percent change")
    public Float getDp() {
        return dp;
    }
