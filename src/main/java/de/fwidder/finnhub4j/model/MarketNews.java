...
public class MarketNews {
     ...
     * @return category
     **/
    @ApiModelProperty(value = "News category.")
     ...
     * @return datetime
     **/
    @ApiModelProperty(value = "Published time in UNIX timestamp.")
     ...
     * @return headline
     **/
    @ApiModelProperty(value = "News headline.")
     ...
     * @return id
     **/
    @ApiModelProperty(value = "News ID. This value can be used for <code>minId</code> params to get the latest news only.")
    public Long getId() {
        return id;
    }
     ...
     * @return image
     **/
    @ApiModelProperty(value = "Thumbnail image URL.")
     ...
     * @return related
     **/
    @ApiModelProperty(value = "Related stocks and companies mentioned in the article.")
     ...
     * @return source
     **/
    @ApiModelProperty(value = "News source.")
     ...
     * @return summary
     **/
    @ApiModelProperty(value = "News summary.")
