...
public class FilingSentiment {
     ...
     * @return negative
     **/
    @ApiModelProperty(value = "% of negative words in the filing.")
     ...
     * @return positive
     **/
    @ApiModelProperty(value = "% of positive words in the filing.")
     ...
     * @return polarity
     **/
    @ApiModelProperty(value = "% of polarity words in the filing.")
     ...
     * @return litigious
     **/
    @ApiModelProperty(value = "% of litigious words in the filing.")
     ...
     * @return uncertainty
     **/
    @ApiModelProperty(value = "% of uncertainty words in the filing.")
     ...
     * @return constraining
     **/
    @ApiModelProperty(value = "% of constraining words in the filing.")
     ...
     * @return modalWeak
     **/
    @ApiModelProperty(value = "% of modal-weak words in the filing.")
     ...
     * @return modalStrong
     **/
    @ApiModelProperty(value = "% of modal-strong words in the filing.")
     ...
     **/
    @ApiModelProperty(value = "% of modal-moderate words in the filing.")
