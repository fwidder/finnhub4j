package de.fwidder.finnhub4j;

import de.fwidder.finnhub4j.auth.ApiKeyAuth;
import de.fwidder.finnhub4j.auth.Authentication;
import de.fwidder.finnhub4j.auth.HttpBasicAuth;
import de.fwidder.finnhub4j.auth.OAuth;
...
@Component("de.fwidder.finnhub.restclient.ApiClient")
public class ApiClient {
    private boolean debugging = false;
    private HttpHeaders defaultHeaders = new HttpHeaders();
    private String basePath = "https://finnhub.io/api/v1";
